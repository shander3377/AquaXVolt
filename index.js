    ...
    switch (args[0]) {
        case 'mute':
            if (!message.guild.me.hasPermission("MANAGE_MESSAGES")) {
                ...
                botnopermissionmuteembed.setDescription("I don't have Ban Members Permission.")
            ...
            muteembed.setDescription(`✅ **${person.user.tag} has been muted for ${ms(ms(time))} because ${reason}**`);
